...
using InstituteApp.Helpers;
using InstituteApp.Authorization;
...
namespace InstituteApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("InstituteApp"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "InstituteApp API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "InstituteApp API V1");
            });
