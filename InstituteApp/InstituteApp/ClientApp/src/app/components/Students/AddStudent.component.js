...
var createStudent = /** @class */ (function () {
    function createStudent(_fb, _avRoute, _router, _studentService, _dataService) {
        ...
        this.studentForm = this._fb.group({
            ...
            RegisterNumber: ['', [forms_1.Validators.required]],
            JoiningDate: ['', [forms_1.Validators.required]],
            Course: ['', [forms_1.Validators.required]],
            Batch: ['', [forms_1.Validators.required]],
            RollNo: [''],
            ...
            personalDetails_Category: ['', [forms_1.Validators.required]],
            ...
            g_contactDetails_Mobile: ['', [forms_1.Validators.required]],
            g_contactDetails_Email: ['', [forms_1.Validators.required]],
            SchoolName: [''],
            SchoolAddress: [''],
            Qualification: ['']
        });
